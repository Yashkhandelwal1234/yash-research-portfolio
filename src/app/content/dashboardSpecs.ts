...
export const dashboardSpecs: DashboardSpec[] = [
  {
    ...
    incentiveOrganicNote: "Base yield is the sustainable engine. Campaign rewards are the accelerator. The dashboard should separate organic allocator yield from incentive-heavy Pendle APYs.",
    riskChecklist: [
      {
